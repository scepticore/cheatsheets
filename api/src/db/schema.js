...
export const cheatsheetViewsTable = sqliteTable("cheatsheet_views", {
  cheatsheet_id: text().notNull(),
  viewer_id: text().default(""),
  view_date: text().notNull().$defaultFn(() => new Date().toISOString()),
})
